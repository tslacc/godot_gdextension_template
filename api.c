...
void load_api(GDExtensionInterfaceGetProcAddress p_get_proc_address){
	...
	api.classdb_unregister_extension_class = p_get_proc_address("classdb_unregister_extension_class");
	...
	printf("string_name_equal %p\n", operators.string_name_equal);
}
